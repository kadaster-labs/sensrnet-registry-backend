...
import { getObservationGoalAddedEvent, ObservationGoalAdded } from '../events/observationgoal/added';
import { getObservationGoalRemovedEvent, ObservationGoalRemoved } from '../events/observationgoal/removed';
import { getObservationGoalUpdatedEvent, ObservationGoalUpdated } from '../events/observationgoal/updated';
...
export class SensorDeviceAggregate extends Aggregate {
