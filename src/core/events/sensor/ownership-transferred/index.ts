...
import { SensorOwnershipTransferred as V1 } from './1/sensor-ownershiptransferred.event';

export { SensorOwnershipTransferred } from './1/sensor-ownershiptransferred.event';
