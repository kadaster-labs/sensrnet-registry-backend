...
import { legalEntityEventStreamName, legalEntityEventType, legalEntityStreamRootValue } from '../../commons/events/legal-entity';
...
export class LegalEntityEsListener extends AbstractEsListener {
    constructor(
        ...
        super(`backend-${legalEntityStreamRootValue}-es`, `${legalEntityEventStreamName}`, eventStore,
