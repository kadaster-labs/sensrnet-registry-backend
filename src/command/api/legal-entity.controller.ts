...
export class LegalEntityController {
    ...
    async registerOrganization(
        ...
        await this.commandBus.execute(
            new AddPublicContactDetailsCommand(
                legalEntityId,
                contactDetailsId,
                registerOrganizationBody.contactDetails.name,
                registerOrganizationBody.contactDetails.email,
                registerOrganizationBody.contactDetails.phone,
            ),
        );
    ...
    async updateContactDetails(
        ...
        return this.commandBus.execute(
            new UpdateContactDetailsCommand(
                user.legalEntityId,
                params.contactDetailsId,
                updateContactDetailsBody.name,
                updateContactDetailsBody.email,
                updateContactDetailsBody.phone,
            ),
        );
    }
