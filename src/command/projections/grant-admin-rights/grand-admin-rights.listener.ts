...
@Injectable()
export class GrantAdminRightsESListener extends LegalEntityEsListener {
    constructor(eventStore: EventStorePublisher, checkpointService: CheckpointService) {
        super(`grant-admin-rights-${legalEntityStreamRootValue}-es`, eventStore, checkpointService);
    }
}
