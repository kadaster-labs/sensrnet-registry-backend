...
export class ObservationGoalController {
  ...
  async retrieveObservationGoal(@Param() observationGoalIdParams: ObservationGoalIdParams): Promise<any> {
    return await this.queryBus.execute(new ObservationGoalQuery(observationGoalIdParams.observationGoalId));
  }
